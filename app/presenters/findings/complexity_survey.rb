...
module Findings
  # Every transitioned run the lab has, read through the complexity its samples record of
  # the dominant replicator after the crossing: the compressed length of that tape and how
  # many instructions it executes (`docs/design_record.md`, evolution programme rung 4).
  ...
  class ComplexitySurvey
    ...
    # crossing. A run whose replicators were never measured by an engine that reports it
    # has nothing to say here and gets no row.
    def rows
