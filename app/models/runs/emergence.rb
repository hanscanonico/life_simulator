...
module Runs
  # A run's confirmed crossing: the earliest crossing its samples hold, from the detector's
  # own on, that the census or the copy rate backs (docs/design_record.md, 2026-09-15), and
  # which of the two backed it.
