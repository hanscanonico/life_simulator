...
module Lab
  ...
  SWEEPS = {
    ...
    "environmental_structure" => {
      ...
      # its runs have emerged.
      seeds: (1..30).to_a,
      # Ninety for the two structured arms: after thirty seeds gradient has one emerged run
      # carrying a complexity reading and patchwork none, short of the two the finding reads
      # an arm on. The uniform control has its two already.
